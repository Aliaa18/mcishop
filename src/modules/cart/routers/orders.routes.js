...
import { getUserOrders , getUsersOrders, removeOrder, updateOrder } from '../controllers/orders.controller.js'
import { validate } from '../../../middlewares/validation.middleware.js'
import { addOrderSchema } from '../validation/orders.validation.js'
const router = Router()

router.route('/:user_id').get(getUserOrders)
router.route('/:userId/:orderId').put(updateOrder).delete(removeOrder)
